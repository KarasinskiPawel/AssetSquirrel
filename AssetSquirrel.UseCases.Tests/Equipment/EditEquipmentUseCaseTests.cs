...
{
    public class EditEquipmentUseCaseTests
    {
        [Fact]
        public async Task UpdateEquipmentAsync_MapsDtoToEntity_AndReturnsRepositoryResult()
        {
            ...
            equipmentRepository.Verify(r => r.UpdateEquipmentAsync(It.IsAny<CoreBusiness.Equipment>()), Times.Once);
        }

        [Fact]
        public async Task UpdateEquipmentAsync_ReturnsFailureWithMessage_WhenRepositoryReportsFailure()
        {
            var equipmentRepository = new Mock<IEquipmentRepository>();
            equipmentRepository
                .Setup(r => r.UpdateEquipmentAsync(It.IsAny<CoreBusiness.Equipment>()))
                .ReturnsAsync(Result<CoreBusiness.Equipment>.Fail("Equipment not found."));
