...
namespace AssetsSquirrel.Plugins.EFCoreSqlServer.Migrations
{
    ...
    [Migration("20260707135317_AddFilePathAndUploadDateToEquipmentReturn")]
    partial class AddFilePathAndUploadDateToEquipmentReturn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.Equipment", b =>
                {
                    ...
                    b.Property<bool>("IsAddedToWarehouse")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentAssignment", b =>
                {
                    ...
                    b.Property<int?>("EquipmentHandoverId")
                        .HasColumnType("int");

                    b.Property<int>("EquipmentId")
                        .HasColumnType("int");

                    b.Property<int?>("EquipmentReturnId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EquipmentHandoverId");

                    b.HasIndex("EquipmentId")
                        .IsUnique()
                        .HasFilter("[DateOfReturn] IS NULL");

                    b.HasIndex("EquipmentReturnId");
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentAssignmentHistory", b =>
                {
                    b.Property<int>("EquipmentAssignmentHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("EquipmentAssignmentHistoryId");

                    b.HasIndex("EmployeeId");

                    b.HasIndex("EquipmentAssignmentId");
                    ...
                    b.ToTable("EquipmentAssignmentHistories");
                });

            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentHandover", b =>
                {
                    b.Property<int>("EquipmentHandoverId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EquipmentHandoverId"));
                    ...
                    b.Property<string>("HandoverDocumentNumber")
                        .IsRequired()
                        .HasMaxLength(12)
                    ...
                    b.HasKey("EquipmentHandoverId");

                    b.HasIndex("FromEmployeeId");

                    b.HasIndex("FromLocationId");

                    b.HasIndex("HandoverDocumentNumber")
                        .IsUnique();
                    ...
                    b.ToTable("EquipmentHandovers");
                });

            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentHandoverDetail", b =>
                {
                    b.Property<int>("EquipmentHandoverDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EquipmentHandoverDetailId"));
                    ...
                    b.HasKey("EquipmentHandoverDetailId");

                    b.HasIndex("EquipmentId");

                    b.HasIndex("EquipmentHandoverId", "EquipmentId")
                        .IsUnique();

                    b.ToTable("EquipmentHandoverDetails");
                });
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentReturn", b =>
                {
                    b.Property<int>("EquipmentReturnId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EquipmentReturnId"));
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.Location", b =>
                {
                    ...
                    b.Property<bool>("EquipmentStorage")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.Equipment", b =>
                {
                    ...
                    b.HasOne("AssetSquirrel.CoreBusiness.Location", "Location")
                        .WithMany()
                    ...
                    b.HasOne("AssetsSquirrel.CoreBusiness.ApplicationUser", "RegisteredByUser")
                        .WithMany("Equipments")
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentAssignment", b =>
                {
                    b.HasOne("AssetSquirrel.CoreBusiness.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AssetSquirrel.CoreBusiness.EquipmentHandover", "EquipmentHandover")
                        .WithMany()
                        .HasForeignKey("EquipmentHandoverId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("AssetSquirrel.CoreBusiness.EquipmentReturn", "EquipmentReturn")
                        .WithMany("EquipmentAssignments")
                        .HasForeignKey("EquipmentReturnId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("EquipmentHandover");

                    b.Navigation("EquipmentReturn");
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentAssignmentHistory", b =>
                {
                    ...
                    b.HasOne("AssetSquirrel.CoreBusiness.EquipmentAssignment", "EquipmentAssignment")
                        .WithMany("EquipmentAssignmentHistories")
                    ...
                    b.Navigation("EquipmentAssignment");
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentHandover", b =>
                {
                    b.HasOne("AssetSquirrel.CoreBusiness.Employee", "FromEmployee")
                        .WithMany()
                        .HasForeignKey("FromEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AssetSquirrel.CoreBusiness.Location", "FromLocation")
                        .WithMany()
                        .HasForeignKey("FromLocationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AssetsSquirrel.CoreBusiness.ApplicationUser", "PreparedByUser")
                        .WithMany()
                        .HasForeignKey("PreparedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AssetSquirrel.CoreBusiness.Employee", "ToEmployee")
                        .WithMany()
                        .HasForeignKey("ToEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AssetSquirrel.CoreBusiness.Location", "ToLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentHandoverDetail", b =>
                {
                    b.HasOne("AssetSquirrel.CoreBusiness.EquipmentHandover", "EquipmentHandover")
                        .WithMany("EquipmentHandoverDetails")
                        .HasForeignKey("EquipmentHandoverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentReturn", b =>
                {
                    ...
                    b.HasOne("AssetSquirrel.CoreBusiness.Location", "StorageLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentAssignment", b =>
                {
                    b.Navigation("EquipmentAssignmentHistories");
                });

            modelBuilder.Entity("AssetSquirrel.CoreBusiness.EquipmentHandover", b =>
                {
                    b.Navigation("EquipmentHandoverDetails");
                });
