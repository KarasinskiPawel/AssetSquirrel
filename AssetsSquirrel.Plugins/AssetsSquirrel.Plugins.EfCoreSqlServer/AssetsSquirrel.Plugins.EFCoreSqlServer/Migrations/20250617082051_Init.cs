        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeReferenceNumber = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmployeeId", "Email", "EmployeeCode", "EmployeeReferenceNumber", "FirstName", "IsActive", "LastName", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, "pawelka@komfort.pl", null, null, "Paweł", true, "Karasiński", null },
                    { 2, "dariusz.gasiorowski@komfort.pl", null, null, "Dariusz", true, "Gąsiorowski", null },
                    { 3, "Konrad.Wawrzyniak@komfort.pl", null, null, "Konrad", true, "Wawrzyniak", null }
                });
