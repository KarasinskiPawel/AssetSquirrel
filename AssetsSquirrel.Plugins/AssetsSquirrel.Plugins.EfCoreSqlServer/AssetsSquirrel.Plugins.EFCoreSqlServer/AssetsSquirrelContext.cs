    ...
    public class AssetsSquirrelContext(DbContextOptions<AssetsSquirrelContext> options) : IdentityDbContext<ApplicationUser>(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().HasData(
                new Employee { EmployeeId = 1, FirstName = "Pawe�", LastName = "Karasi�ski", Email = "pawelka@komfort.pl", PhoneNumber = null, IsActive = true },
            ...
            modelBuilder.Entity<Location>().HasData(
                ...
                new Location { LocationId = 2, Code = "S000", MPK = "PL1C001Z", City = "��d�", Street = "Biuro - Srebrzy�ska 14", Email = "", PhoneNumber = "", IsActive = true },
                new Location { LocationId = 3, Code = "N001", MPK = "PL1N001Z", City = "��d�", Street = "Magazyn IT - Srebrzy�ska 14", Email = "", PhoneNumber = "", IsActive = true }
                );
